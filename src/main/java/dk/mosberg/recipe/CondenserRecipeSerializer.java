...
public class CondenserRecipeSerializer implements RecipeSerializer<Recipe<?>> {
    @Override
    public Recipe<?> read(Identifier id, JsonObject json) {
        // TODO: Implement reading from JSON
        throw new UnsupportedOperationException(
                "CondenserRecipeSerializer.read from JSON is not implemented");
    }
    ...
    public Recipe<?> read(Identifier id, PacketByteBuf buf) {
        ...
        throw new UnsupportedOperationException(
                "CondenserRecipeSerializer.read from network is not implemented");
    }
