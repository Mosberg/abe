...
This guide covers the basics of creating Minecraft-style models using Blockbench. It includes information on element count, shape depiction, UV mapping, mixels, size and proportions.
...
This guide covers the basics of creating pixel art textures for Minecraft using Blockbench. It includes information on color theory, shading techniques, common pitfalls to avoid, and specific guidelines for item and block textures.
